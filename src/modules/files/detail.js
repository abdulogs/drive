...
$(document).on("click", ".detailBtn", function (e) {
    ...
    $.ajax({
        ...
        success: function (item) {
            ...
            <h3 class="m-0 fw-semibold font-14 py-1">File</h3>
            <p class="m-0 font-14 mb-2"><a href="${item.file}" download="${item.name}" class="text-primary fw-bold text-decoration-none">Download<a></p>
